...
let jobListing = document.querySelectorAll(".jobContainer").forEach(function(jobContainer) {
  ...
  let jobName = jobContainer.querySelector("#jobTitle");
  let jobColor = jobContainer.querySelector("#jobColorContainer")
  ...
  let imageUrl = "/static/mesh" + (Math.floor(Math.random() * 4) + 1) + ".png";

  jobColor.style.backgroundImage = "url(" + imageUrl + ")";
